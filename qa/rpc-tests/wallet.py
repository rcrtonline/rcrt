...
#   c) node1 mines 32 blocks, so now node 0 has 500000RCRT, node 1 has 4250RCRT, node2 has none.
#   d) node0 sends 601 RCRT to node2, in two transactions (301 RCRT, then 300 RCRT).
