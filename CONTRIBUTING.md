Contributing to Recruit Core
==================================

The Recruit Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Recruit Core project, and is not to be
confused with overall Recruit Network Protocol consensus changes.

Whether a pull request is merged into Recruit Core rests with the project merge
...
Patches that change Recruit consensus rules are considerably more involved than
...
Where a patch set proposes to change the Recruit consensus, it must have been
...
The project leader is the release manager for each Recruit Core release.
