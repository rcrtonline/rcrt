                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Recruit Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a RCRT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and recruit: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Recruit Core"), this);
    aboutAction->setStatusTip(tr("Show information about Recruit Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Recruit"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your RCRT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified RCRT addresses"));
    ...
    openAction->setStatusTip(tr("Open a recruit: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Recruit Core help message to get a list with possible Recruit command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Recruit Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Recruit network", "", count));
}
...
{
    QString strTitle = tr("Recruit Core"); // default title
