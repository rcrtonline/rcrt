...
/** Utility functions used by the Recruit Qt UI.
 */
namespace GUIUtil
{
...
// Render RCRT addresses in monospace font
...
// Parse "recruit:" URI into recipient object, return true on successful parsing
