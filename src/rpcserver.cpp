...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Recruit server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Recruit features */
        {"recruit", "masternode", &masternode, true, true, false},
        {"recruit", "listmasternodes", &listmasternodes, true, true, false},
        {"recruit", "getmasternodecount", &getmasternodecount, true, true, false},
        {"recruit", "masternodeconnect", &masternodeconnect, true, true, false},
        {"recruit", "masternodecurrent", &masternodecurrent, true, true, false},
        {"recruit", "masternodedebug", &masternodedebug, true, true, false},
        {"recruit", "startmasternode", &startmasternode, true, true, false},
        {"recruit", "createmasternodekey", &createmasternodekey, true, true, false},
        {"recruit", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"recruit", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"recruit", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"recruit", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"recruit", "getmasternodescores", &getmasternodescores, true, true, false},
        {"recruit", "mnbudget", &mnbudget, true, true, false},
        {"recruit", "preparebudget", &preparebudget, true, true, false},
        {"recruit", "submitbudget", &submitbudget, true, true, false},
        {"recruit", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"recruit", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"recruit", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"recruit", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"recruit", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"recruit", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"recruit", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"recruit", "checkbudgets", &checkbudgets, true, true, false},
        {"recruit", "mnsync", &mnsync, true, true, false},
        {"recruit", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> recruit-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:50303/\n";
}
