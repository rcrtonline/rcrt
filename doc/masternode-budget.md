...
Recruit now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<recruit_address\> \<monthly_payment_recruit\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ RCRT, _12_ times over the course of a year totaling _24000_ RCRT.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<recruit_address\> \<monthly_payment_recruit\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` RCRT.
 ...
 * vote-many          - Vote on a Recruit initiative
 * vote-alias         - Vote on a Recruit initiative
 * vote               - Vote on a Recruit initiative/budget
