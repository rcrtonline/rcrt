...
In order to support loading of multiple wallets in recruit-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is recruit.cpp.
...
Changes to recruit.cpp
----------------------
recruit.cpp is the entry point into recruit-qt, and as such, will require some minor modifications to provide hooks for
