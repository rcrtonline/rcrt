...
This mechanism has been integrated into Bitcore-Node-Recruit which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/recruit/insight-api-recruit#web-socket-api](https://github.com/recruit/insight-api-recruit#web-socket-api)
* API: [https://github.com/recruit/insight-api-recruit#swifttx-transactions](https://github.com/recruit/insight-api-recruit#swifttx-transactions)
...
By default, the Recruit Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Recruit Core daemon:
