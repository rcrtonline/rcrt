...
Intro
-----
Recruit (RCRT) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Recruit utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run recruit-qt.exe.

Recruit Core is the original Recruit client and it builds the backbone of the network.
However, it downloads and stores the entire history of Recruit transactions;
