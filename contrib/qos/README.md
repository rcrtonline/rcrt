...
This means one can have an always-on recruitd instance running, and another local recruitd/recruit-qt instance which connects to this node and receives blocks from it.
