...
RESOURCES += src/qt/recruit.qrc src/qt/recruit_locale.qrc

TRANSLATIONS += src/qt/locale/recruit_bg.ts \
                src/qt/locale/recruit_de.ts \
                src/qt/locale/recruit_en.ts \
                src/qt/locale/recruit_es.ts \
                src/qt/locale/recruit_fi.ts \
                src/qt/locale/recruit_fr.ts \
                src/qt/locale/recruit_it.ts \
                src/qt/locale/recruit_ja.ts \
                src/qt/locale/recruit_pl.ts \
                src/qt/locale/recruit_pt.ts \
                src/qt/locale/recruit_ru.ts \
                src/qt/locale/recruit_sk.ts \
                src/qt/locale/recruit_sv.ts \
                src/qt/locale/recruit_vi.ts \
                src/qt/locale/recruit_zh_CN.ts \
                src/qt/locale/recruit_zh_TW.ts
